package org.blogsite.youngsoft.tableview;
...
import org.blogsite.youngsoft.tableview.listeners.SortingStatusChangeListener;
import org.blogsite.youngsoft.tableview.listeners.TableHeaderClickListener;
import org.blogsite.youngsoft.tableview.providers.SortStateViewProvider;
...
public class SortableTableView<T> extends TableView<T> {
     ...
     */
    public void setColumnComparator(final int columnIndex, final Comparator<T> columnComparator, boolean sortable) {
        sortingController.setComparator(columnIndex, columnComparator, sortable);
    }
    ...
    private class SortingController implements TableHeaderClickListener {
        ...
        public void setComparator(final int columnIndex, final Comparator<T> columnComparator, boolean sortable) {
            if (columnComparator == null || !sortable) {
